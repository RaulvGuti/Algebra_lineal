...
class WindowRestaOp:
    def __init__(self):
        ...
        # Label Ventana
        self.resta_label = customtkinter.CTkLabel(master=self.frame, text='Resta de Matrices', font=("Arial", 40))
        self.resta_label.pack(padx=40, pady=40)
        self.resta_label.place(x=10, y=10)

        # Ingreso Tamaño de Matriz
        self.tamanio_filas_input = customtkinter.CTkEntry(master=self.frame, placeholder_text='Fil', width=60,
                                                          height=35)
        self.tamanio_filas_input.pack(padx=40, pady=40)
        self.tamanio_filas_input.place(x=10, y=60)

        self.tamanio_columnas_input = customtkinter.CTkEntry(master=self.frame, placeholder_text='Col', width=60,
                                                             height=35)
        ...
        self.tamanio_label = customtkinter.CTkLabel(master=self.frame, text='Al realizar una Resta de matrices, ambas '
        ...
        self.no_matrices_input = customtkinter.CTkEntry(master=self.frame, placeholder_text='No. Matrices', width=85,
                                                        height=35)
        ...
        self.no_matrices_label = customtkinter.CTkLabel(master=self.frame, text='¿Cuántas Matrices Restará?\nMaximo 4('
        ...
        self.matrizC_label = customtkinter.CTkLabel(master=self.frame, text='Matriz 1', font=("Arial", 15))
        ...
        self.matrizD_label = customtkinter.CTkLabel(master=self.frame, text='Matriz 1', font=("Arial", 15))
        ...
        # Generar Boton Resta
        self.resta_bt = customtkinter.CTkButton(master=self.frame, text='RESTAR', height=35, width=60,
                                               font=("Arial", 20), fg_color="#3E4446", command=self.restar_matriz)
        self.resta_bt.pack(padx=40, pady=40)
        self.resta_bt.place(x=800, y=250)
    ...
    def clear_window(self):
        ...
        self.matrizC_label.destroy()
        self.matrizC_1_input.destroy()
        self.matrizC_2_input.destroy()
        self.matrizC_3_input.destroy()
        self.matrizC_4_input.destroy()
        self.matrizC_5_input.destroy()
        self.matrizC_6_input.destroy()
        self.matrizC_7_input.destroy()
        self.matrizC_8_input.destroy()
        self.matrizC_9_input.destroy()
        self.matrizC_10_input.destroy()
        self.matrizC_11_input.destroy()
        self.matrizC_12_input.destroy()
        self.matrizC_13_input.destroy()
        self.matrizC_14_input.destroy()
        self.matrizC_15_input.destroy()
        self.matrizC_16_input.destroy()

        self.matrizD_label.destroy()
        self.matrizD_1_input.destroy()
        self.matrizD_2_input.destroy()
        self.matrizD_3_input.destroy()
        self.matrizD_4_input.destroy()
        self.matrizD_5_input.destroy()
        self.matrizD_6_input.destroy()
        self.matrizD_7_input.destroy()
        self.matrizD_8_input.destroy()
        self.matrizD_9_input.destroy()
        self.matrizD_10_input.destroy()
        self.matrizD_11_input.destroy()
        self.matrizD_12_input.destroy()
        self.matrizD_13_input.destroy()
        self.matrizD_14_input.destroy()
        self.matrizD_15_input.destroy()
        self.matrizD_16_input.destroy()
    ...
    def no_matrices_action(self):  # Accion del numero de matrices boton, verifica el dato y me da el numero de matrices
        if int(self.no_matrices_input.get()) <= 1:
            ...
            if int(self.no_matrices_input.get()) == 2:
                self.matrizC_label.destroy()
                self.matrizC_1_input.destroy()
                self.matrizC_2_input.destroy()
                self.matrizC_3_input.destroy()
                ...
                self.matrizD_15_input.destroy()
                self.matrizD_16_input.destroy()
            elif int(self.no_matrices_input.get()) == 3:
                self.matrizD_label.destroy()
                self.matrizD_1_input.destroy()
                self.matrizD_2_input.destroy()
                self.matrizD_3_input.destroy()
        ...
        if tamanio_fila == tamanio_columna:
            ...
            if tamanio_fila == 2:
                ...
                if tamanio_columna == 2:
                    ...
                    self.matrizC_5_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizC_5_input.pack(padx=40, pady=40)
                    self.matrizC_5_input.place(x=410, y=270)

                    self.matrizC_6_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizC_6_input.pack(padx=40, pady=40)
                    self.matrizC_6_input.place(x=455, y=270)
                elif tamanio_columna == 4:
                    self.matrizC_label = customtkinter.CTkLabel(master=self.frame, text='Matriz 3', font=("Arial", 15))
                    self.matrizC_label.pack(padx=40, pady=40)
                    self.matrizC_label.place(x=455, y=150)
                ...
                if tamanio_columna == 2:
                    ...
                    self.matrizC_7_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizC_7_input.pack(padx=40, pady=40)
                    self.matrizC_7_input.place(x=410, y=315)

                    self.matrizC_8_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizC_8_input.pack(padx=40, pady=40)
                    self.matrizC_8_input.place(x=455, y=315)
                elif tamanio_columna == 3:
                    self.matrizC_label = customtkinter.CTkLabel(master=self.frame, text='Matriz 3', font=("Arial", 15))
                    self.matrizC_label.pack(padx=40, pady=40)
                    self.matrizC_label.place(x=455, y=150)
                    ...
                    self.matrizC_10_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizC_10_input.pack(padx=40, pady=40)
                    self.matrizC_10_input.place(x=410, y=315)

                    self.matrizC_11_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizC_11_input.pack(padx=40, pady=40)
                    self.matrizC_11_input.place(x=455, y=315)

                    self.matrizC_12_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizC_12_input.pack(padx=40, pady=40)
                    self.matrizC_12_input.place(x=500, y=315)
        ...
        if tamanio_fila == tamanio_columna:
            ...
            if tamanio_fila == 2:
                ...
                if tamanio_columna == 2:
                    ...
                    self.matrizD_5_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizD_5_input.pack(padx=40, pady=40)
                    self.matrizD_5_input.place(x=610, y=270)

                    self.matrizD_6_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizD_6_input.pack(padx=40, pady=40)
                    self.matrizD_6_input.place(x=655, y=270)
                elif tamanio_columna == 4:
                    self.matrizD_label = customtkinter.CTkLabel(master=self.frame, text='Matriz 4', font=("Arial", 15))
                    self.matrizD_label.pack(padx=40, pady=40)
                    self.matrizD_label.place(x=655, y=150)
                ...
                if tamanio_columna == 2:
                    ...
                    self.matrizD_7_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizD_7_input.pack(padx=40, pady=40)
                    self.matrizD_7_input.place(x=610, y=315)

                    self.matrizD_8_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizD_8_input.pack(padx=40, pady=40)
                    self.matrizD_8_input.place(x=655, y=315)
                elif tamanio_columna == 3:
                    self.matrizD_label = customtkinter.CTkLabel(master=self.frame, text='Matriz 4', font=("Arial", 15))
                    self.matrizD_label.pack(padx=40, pady=40)
                    self.matrizD_label.place(x=655, y=150)
                    ...
                    self.matrizD_10_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizD_10_input.pack(padx=40, pady=40)
                    self.matrizD_10_input.place(x=610, y=315)

                    self.matrizD_11_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizD_11_input.pack(padx=40, pady=40)
                    self.matrizD_11_input.place(x=655, y=315)

                    self.matrizD_12_input = customtkinter.CTkEntry(master=self.frame, width=40, height=40)
                    self.matrizD_12_input.pack(padx=40, pady=40)
                    self.matrizD_12_input.place(x=700, y=315)

    def restar_matriz(self):  # Parte logica de la resta
        pass
